...
/**
 * 
 * This is the JMX MBean for reporting the NameNode Activity. The MBean is
 * register using the name "hadoop:service=NameNode,name=NameNodeActivity"
 * 
...
public class NameNodeActivtyMBean extends MetricsDynamicMBeanBase {
	...
	protected NameNodeActivtyMBean(final MetricsRegistry mr) {
		...
		mbeanName = MBeanUtil.registerMBean("NameNode", "NameNodeActivity",
				this);
	}
