...
public abstract class MetricsDynamicMBeanBase implements DynamicMBean {
	...
	private void createMBeanInfo() {
		...
		for (MetricsBase o : metricsRegistry.getMetricsList()) {
			...
			if (MetricsTimeVaryingRate.class.isInstance(o)) {
				...
				attributesInfo.add(new MBeanAttributeInfo(
						o.getName() + NUM_OPS, "java.lang.Integer", o
								.getDescription(), true, false, false));
				attributesInfo.add(new MBeanAttributeInfo(o.getName()
						+ AVG_TIME, "java.lang.Long", o.getDescription(), true,
						false, false));
				attributesInfo.add(new MBeanAttributeInfo(o.getName()
						+ MIN_TIME, "java.lang.Long", o.getDescription(), true,
						false, false));
				attributesInfo.add(new MBeanAttributeInfo(o.getName()
						+ MAX_TIME, "java.lang.Long", o.getDescription(), true,
						false, false));
				...
				attributesInfo.add(new MBeanAttributeInfo(o.getName(),
						"java.lang.Integer", o.getDescription(), true, false,
						false));
			} else if (MetricsLongValue.class.isInstance(o)
					|| MetricsTimeVaryingLong.class.isInstance(o)) {
				attributesInfo.add(new MBeanAttributeInfo(o.getName(),
						"java.lang.Long", o.getDescription(), true, false,
						false));
			} else {
			...
			if (needsMinMaxResetOperation) {
				operationsInfo = new MBeanOperationInfo[] { new MBeanOperationInfo(
						RESET_ALL_MIN_MAX_OP, "Reset (zero) All Min Max", null,
						"void", MBeanOperationInfo.ACTION) };
			}
		}
		MBeanAttributeInfo[] attrArray = new MBeanAttributeInfo[attributesInfo
				.size()];
	...
	public void setAttribute(Attribute attribute)
		...
		throw new ReflectionException(new NoSuchMethodException("set"
				+ attribute));
	}
