...
public class LogLevel {
	public static final String USAGES = "\nUSAGES:\n" + "java "
			+ LogLevel.class.getName() + " -getlevel <host:port> <name>\n"
	...
	public static class Servlet extends HttpServlet {
		...
		public void doGet(HttpServletRequest request,
			...
			if (logName != null) {
				...
				out.println(MARKER + "Submitted Log Name: <b>" + logName
						+ "</b><br />");

				Log log = LogFactory.getLog(logName);
				out.println(MARKER + "Log Class: <b>"
						+ log.getClass().getName() + "</b><br />");
				if (level != null) {
					out.println(MARKER + "Submitted Level: <b>" + level
							+ "</b><br />");
				}
				...
				if (log instanceof Log4JLogger) {
					...
					out.println("Sorry, " + log.getClass()
							+ " not supported.<br />");
				}
			}
		...
		private static void process(org.apache.log4j.Logger log, String level,
			...
			if (level != null) {
				...
				out
						.println(MARKER + "Setting Level to " + level
								+ " ...<br />");
			}
			out.println(MARKER + "Effective level: <b>"
					+ log.getEffectiveLevel() + "</b><br />");
		}
