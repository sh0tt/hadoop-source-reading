...
public class JFloat extends JType {
	...
	class JavaFloat extends JavaType {
		...
		void genSlurpBytes(CodeBuffer cb, String b, String s, String l) {
			...
			cb.append("if (" + l + "<4) {\n");
			cb
					.append("throw new java.io.IOException(\"Float is exactly 4 bytes."
		...
		void genCompareBytes(CodeBuffer cb) {
			...
			cb.append("}\n");
			cb
					.append("float f1 = org.apache.hadoop.record.Utils.readFloat(b1, s1);\n");
			cb
					.append("float f2 = org.apache.hadoop.record.Utils.readFloat(b2, s2);\n");
			cb.append("if (f1 != f2) {\n");
