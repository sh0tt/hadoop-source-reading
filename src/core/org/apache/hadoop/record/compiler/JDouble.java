...
public class JDouble extends JType {
	...
	class JavaDouble extends JavaType {
		...
		void genHashCode(CodeBuffer cb, String fname) {
			...
			cb.append(Consts.RIO_PREFIX + "ret = (int)(" + tmp + "^(" + tmp
					+ ">>>32));\n");
		}
		...
		void genSlurpBytes(CodeBuffer cb, String b, String s, String l) {
			...
			cb.append("if (" + l + "<8) {\n");
			cb
					.append("throw new java.io.IOException(\"Double is exactly 8 bytes."
		...
		void genCompareBytes(CodeBuffer cb) {
			...
			cb.append("}\n");
			cb
					.append("double d1 = org.apache.hadoop.record.Utils.readDouble(b1, s1);\n");
			cb
					.append("double d2 = org.apache.hadoop.record.Utils.readDouble(b2, s2);\n");
			cb.append("if (d1 != d2) {\n");
