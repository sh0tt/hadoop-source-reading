...
public class JMap extends JCompType {
	...
	class JavaMap extends JavaCompType {
		...
		JavaMap(JType.JavaType key, JType.JavaType value) {
			super("java.util.TreeMap<" + key.getWrapperType() + ","
					+ value.getWrapperType() + ">", "Map",
					"java.util.TreeMap<" + key.getWrapperType() + ","
		...
		void genCompareTo(CodeBuffer cb, String fname, String other) {
			...
			cb.append("for(; " + getId(Consts.RIO_PREFIX + "miter1")
					+ ".hasNext() && " + getId(Consts.RIO_PREFIX + "miter2")
					+ ".hasNext();) {\n");
			cb.append(key.getType() + " " + getId(Consts.RIO_PREFIX + "k1")
					+ " = " + getId(Consts.RIO_PREFIX + "miter1")
					+ ".next();\n");
			cb.append(key.getType() + " " + getId(Consts.RIO_PREFIX + "k2")
					+ " = " + getId(Consts.RIO_PREFIX + "miter2")
					+ ".next();\n");
			...
			cb.append(Consts.RIO_PREFIX + "ret = ("
					+ getId(Consts.RIO_PREFIX + "set1") + ".size() - "
		...
		void genReadMethod(CodeBuffer cb, String fname, String tag, boolean decl) {
			...
			cb.append("for (; !" + getId(Consts.RIO_PREFIX + "midx")
					+ ".done(); " + getId(Consts.RIO_PREFIX + "midx")
					+ ".incr()) {\n");
	...
	class CppMap extends CppCompType {
		...
		String getTypeIDObjectString() {
			return "new ::hadoop::MapTypeID(" + key.getTypeIDObjectString()
					+ ", " + value.getTypeIDObjectString() + ")";
		}
