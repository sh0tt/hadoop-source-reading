...
public class ServiceAuthorizationManager {
	...
	private static Map<Class<?>, Permission> protocolToPermissionMap = Collections
			.synchronizedMap(new HashMap<Class<?>, Permission>());
	...
	/**
	 * Check if the given {@link Subject} has all of necessary
	 * {@link Permission} set.
	 * 
	 * @param user
	 *            <code>Subject</code> to be authorized
	 * @param permissions
	 *            <code>Permission</code> set
	 * @throws AuthorizationException
	 *             if the authorization failed
	 */
	private static void checkPermission(final Subject user,
			final Permission... permissions) throws AuthorizationException {
		try {
