...
public class TestFairScheduler extends TestCase {
	...
	public void testSizeBasedWeight() throws Exception {
		...
		assertTrue(scheduler.infos.get(job2).mapFairShare > scheduler.infos
				.get(job1).mapFairShare);
		assertTrue(scheduler.infos.get(job1).reduceFairShare > scheduler.infos
				.get(job2).reduceFairShare);
	}
	...
	public void testWaitForMapsBeforeLaunchingReduces() {
		...
		// However, if we set waitForMapsBeforeLaunchingReduces to true, we
		// should
