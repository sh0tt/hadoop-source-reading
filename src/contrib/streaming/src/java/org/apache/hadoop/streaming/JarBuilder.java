...
public class JarBuilder {
		...
		try {
			if (srcNames != null) {
				...
				while (iter.hasNext()) {
					...
					if (!fsource.exists()) {
						throwing = true;
						throw new FileNotFoundException(fsource
								.getAbsolutePath());
					}
	...
	void addDirectory(JarOutputStream dst, String jarBaseName, File dir,
	...
	public static void main(String args[]) {
		...
		if (args.length < 2) {
			System.err
					.println("Usage: JarFiles merged.jar [src.jar | dir | file ]+");
		} else {
