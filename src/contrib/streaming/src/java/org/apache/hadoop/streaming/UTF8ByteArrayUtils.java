...
public class UTF8ByteArrayUtils {
	...
	public static int findByte(byte[] utf, int start, int end, byte b) {
		return org.apache.hadoop.util.UTF8ByteArrayUtils.findByte(utf, start,
				end, b);
	}
	...
	public static int findNthByte(byte[] utf, int start, int length, byte b,
			int n) {
		return org.apache.hadoop.util.UTF8ByteArrayUtils.findNthByte(utf,
				start, length, b, n);
	}
	 ...
	 */
	@Deprecated
	public static void splitKeyVal(byte[] utf, int start, int length, Text key,
			Text val, int splitPos, int separatorLength) throws IOException {
	...
	@Deprecated
	public static void splitKeyVal(byte[] utf, int start, int length, Text key,
			Text val, int splitPos) throws IOException {
		StreamKeyValUtil.splitKeyVal(utf, start, length, key, val, splitPos);
	}
	 ...
	 */
	@Deprecated
	public static void splitKeyVal(byte[] utf, Text key, Text val,
			int splitPos, int separatorLength) throws IOException {
