...
public class StderrApp {
	 ...
	 */
	public static void go(int preWriteLines, int sleep, int postWriteLines)
			throws IOException {
	...
	public static void go(int preWriteLines, int sleep, int postWriteLines,
		...
		while (postWriteLines > 0) {
			--postWriteLines;
			System.err
					.println("some stderr output after reading input, lines remaining "
							+ postWriteLines);
		}
	}
