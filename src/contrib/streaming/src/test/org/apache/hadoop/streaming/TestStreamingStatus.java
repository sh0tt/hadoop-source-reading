...
/**
 * Tests for the ability of a streaming task to set the status by writing
 * "reporter:status:" lines to stderr. Uses MiniMR since the local jobtracker
 * doesn't track status.
 */
public class TestStreamingStatus extends TestCase {
	...
	protected String map = StreamUtil.makeJavaCommand(StderrApp.class,
			new String[] { "3", "0", "0", "true" });
