...
public class OfflineAnonymizer {
	...
	public void anonymize() throws Exception {
		...
		bfw.flush();
		bfw.close();
		System.out.println("Anonymized log records written to "
				+ logfile.getName() + ".anonymized");

		System.out.println("Compressing output file...");
		LocalStore.zipCompress(logfile.getName() + ".anonymized");
		System.out.println("Compressed output file written to "
				+ logfile.getName() + ".anonymized"
	...
	public static void main(String[] args) {
		...
		if (args.length < 2) {
			System.out
					.println("Usage: OfflineAnonymizer <log_type> <filename>");
			System.out
