...
public class TestUnixUserGroupInformation extends TestCase {
	...
	public void testLogin() throws Exception {
		...
		UnixUserGroupInformation curUserGroupInfo = UnixUserGroupInformation
				.login(conf);
	...
	public void testConstructor() throws Exception {
		UnixUserGroupInformation uugi = new UnixUserGroupInformation(USER_NAME,
				GROUP_NAMES);
	...
	public void testWritable() throws Exception {
		UnixUserGroupInformation ugi = new UnixUserGroupInformation(USER_NAME,
				GROUP_NAMES);
