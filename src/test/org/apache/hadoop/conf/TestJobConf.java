...
public class TestJobConf extends TestCase {
	...
	public void testProfileParamsSetter() {
		...
		Assert.assertEquals("test", configuration
				.get("mapred.task.profile.params"));
	}
	...
	public void testMemoryConfigForMapOrReduceTask() {
		...
		configuration.set("mapred.task.maxvmem", String
				.valueOf(2 * 1024 * 1024));
		configuration.set("mapred.job.map.memory.mb", String.valueOf(300));
		configuration.set("mapred.job.reduce.memory.mb", String.valueOf(300));
	...
	/**
	 * Test that negative values for MAPRED_TASK_MAXVMEM_PROPERTY cause new
	 * configuration keys' values to be used.
	 */
	...
	public void testNegativeValuesForMemoryParams() {
		...
		Assert.assertEquals(JobConf.DISABLED_MEMORY_LIMIT, configuration
				.getMemoryForMapTask());
		Assert.assertEquals(JobConf.DISABLED_MEMORY_LIMIT, configuration
	...
	public void testMaxVirtualMemoryForTask() {
		...
		Assert.assertEquals(configuration.getMaxVirtualMemoryForTask(),
				300 * 1024 * 1024);
