...
public class TestSetTimes extends TestCase {
	...
	static final SimpleDateFormat dateForm = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm");
	...
	public void testTimes() throws IOException {
		...
		try {
			...
			System.out.println("new atime on " + file1 + " is " + adate3 + " ("
					+ atime3 + ")");
			...
			System.out.println("new mtime on " + file1 + " is " + mdate3 + " ("
					+ mtime3 + ")");
