...
public class TestSimulatedFSDataset extends TestCase {
	...
	public void testStorageUsage() throws IOException {
		...
		assertEquals(fsdataset.getCapacity() - bytesAdded, fsdataset
				.getRemaining());

	}

	void checkBlockDataAndSize(FSDatasetInterface fsdataset, Block b,
	...
	public void testInjectionEmpty() throws IOException {
		...
		assertEquals(sfsdataset.getCapacity() - bytesAdded, sfsdataset
				.getRemaining());
	}
