...
public class TestDiskError extends TestCase {
	public void testShutdown() throws Exception {
		...
		File dir1 = new File(new File(dataDir, "data" + (2 * dnIndex + 1)),
				"tmp");
		File dir2 = new File(new File(dataDir, "data" + (2 * dnIndex + 2)),
				"tmp");
		try {
	...
	public void testReplicationError() throws Exception {
		...
		try {
			...
			LocatedBlocks blocks = cluster.getNameNode().namesystem
			...
			String dataDir = cluster.getDataDirectory();
			File dir1 = new File(new File(dataDir, "data" + (2 * sndNode + 1)),
					"tmp");
			File dir2 = new File(new File(dataDir, "data" + (2 * sndNode + 2)),
					"tmp");
