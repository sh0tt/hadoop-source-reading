...
public class TestDFSRollback extends TestCase {
	...
	private static final Log LOG = LogFactory
			.getLog("org.apache.hadoop.hdfs.TestDFSRollback");
	...
	public void testRollback() throws Exception {
		...
		for (int numDirs = 1; numDirs <= 2; numDirs++) {
			...
			UpgradeUtilities.createStorageDirs(NAME_NODE, nameNodeDirs,
					"current");
			UpgradeUtilities.createStorageDirs(NAME_NODE, nameNodeDirs,
					"previous");
			...
			UpgradeUtilities.createStorageDirs(NAME_NODE, nameNodeDirs,
					"previous");
			cluster = new MiniDFSCluster(conf, 0, StartupOption.ROLLBACK);
			UpgradeUtilities.createStorageDirs(DATA_NODE, dataNodeDirs,
					"current");
			UpgradeUtilities.createStorageDirs(DATA_NODE, dataNodeDirs,
					"previous");
			cluster
			...
			log(
					"DataNode rollback with future stored layout version in previous",
					numDirs);
			UpgradeUtilities.createStorageDirs(NAME_NODE, nameNodeDirs,
					"current");
			UpgradeUtilities.createStorageDirs(NAME_NODE, nameNodeDirs,
			...
			UpgradeUtilities.createStorageDirs(DATA_NODE, dataNodeDirs,
					"current");
			baseDirs = UpgradeUtilities.createStorageDirs(DATA_NODE,
					dataNodeDirs, "previous");
			...
			UpgradeUtilities.createStorageDirs(NAME_NODE, nameNodeDirs,
					"current");
			baseDirs = UpgradeUtilities.createStorageDirs(NAME_NODE,
					nameNodeDirs, "previous");
			for (File f : baseDirs) {
			...
			log("NameNode rollback with old layout version in previous",
					numDirs);
			UpgradeUtilities.createStorageDirs(NAME_NODE, nameNodeDirs,
					"current");
			baseDirs = UpgradeUtilities.createStorageDirs(NAME_NODE,
			...
			UpgradeUtilities.createVersionFile(NAME_NODE, baseDirs,
					new StorageInfo(1, UpgradeUtilities
							.getCurrentNamespaceID(null), UpgradeUtilities
