...
public class TestDataTransferProtocol extends TestCase {
	...
	private static final Log LOG = LogFactory
			.getLog("org.apache.hadoop.hdfs.TestDataTransferProtocol");
		...
		try {
			...
			if (eofExpected) {
				throw new IOException(
						"Did not recieve IOException when an exception "
	...
	public void testDataTransferProtocol() throws IOException {
		...
		recvOut.writeShort((short) DataTransferProtocol.OP_STATUS_ERROR);
		sendRecvData("negative DATA_CHUNK len while writing block "
				+ newBlockId, true);
