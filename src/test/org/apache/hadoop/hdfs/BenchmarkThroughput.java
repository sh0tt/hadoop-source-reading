...
public class BenchmarkThroughput extends Configured implements Tool {
	...
	private void writeAndReadLocalFile(String name, Configuration conf,
	...
	private void writeAndReadFile(FileSystem fs, String name,
			Configuration conf, long size) throws IOException {
		Path f = null;
		try {
