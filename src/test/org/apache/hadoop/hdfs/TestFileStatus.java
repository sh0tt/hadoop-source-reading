...
public class TestFileStatus extends TestCase {
	...
	public void testFileStatus() throws IOException {
		...
		try {
			...
			assertTrue(dir + " should be a directory", fs.getFileStatus(path)
					.isDir() == true);
			assertTrue(dir + " should be zero size ", fs.getContentSummary(dir)
					.getLength() == 0);
			assertTrue(dir + " should be zero size ", fs.getFileStatus(dir)
					.getLen() == 0);
