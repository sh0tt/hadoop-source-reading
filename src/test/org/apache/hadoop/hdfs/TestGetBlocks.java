...
public class TestGetBlocks extends TestCase {
	...
	public void testGetBlocks() throws Exception {
		...
		try {
			...
			boolean notWritten;
			do {
				final DFSClient dfsclient = new DFSClient(NameNode
						.getAddress(CONF), CONF);
				locatedBlocks = dfsclient.namenode.getBlockLocations(
						"/tmp.txt", 0, fileLen).getLocatedBlocks();
			...
			NamenodeProtocol namenode = (NamenodeProtocol) RPC.getProxy(
					...
					UnixUserGroupInformation.login(CONF), CONF, NetUtils
