...
public class TestGetSplitHosts extends TestCase {
	...
	public void testGetSplitHosts() throws Exception {
		...
		bs[0] = new BlockLocation(block1Names, block1Hosts, block1Paths, 0,
				block1Size);
		...
		bs[1] = new BlockLocation(block2Names, block2Hosts, block2Paths,
		...
		bs[2] = new BlockLocation(block3Names, block3Hosts, block3Paths,
				block1Size + block2Size, block3Size);
		...
		bs[1] = new BlockLocation(block2Names, block2Hosts, block1Size,
				block2Size);
		bs[2] = new BlockLocation(block3Names, block3Hosts, block1Size
				+ block2Size, block3Size);
