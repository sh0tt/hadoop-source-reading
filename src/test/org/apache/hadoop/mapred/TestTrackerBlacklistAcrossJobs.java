...
public class TestTrackerBlacklistAcrossJobs extends TestCase {
	private static final String hosts[] = new String[] { "host1.rack.com",
			"host2.rack.com", "host3.rack.com" };
	final Path inDir = new Path("/testing");
	final Path outDir = new Path("/output");

	public static class SleepJobFailOnHost extends MapReduceBase implements
	...
	public void testBlacklistAcrossJobs() throws IOException {
		...
		mr = new MiniMRCluster(3, fileSys.getUri().toString(), 1, null, hosts,
				jtConf);
		...
		assertEquals("Didn't blacklist the host", 1, jc.getClusterStatus()
