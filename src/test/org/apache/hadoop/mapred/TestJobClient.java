...
public class TestJobClient extends ClusterMapReduceTestCase {
	...
	private int runTool(Configuration conf, Tool tool, String[] args,
	...
	public void testGetCounter() throws Exception {
		...
		int exitCode = runTool(createJobConf(), new JobClient(), new String[] {
				"-counter", jobId, "org.apache.hadoop.mapred.Task$Counter",
