...
public class TestMiniMRClasspath extends TestCase {
	...
	static String launchWordCount(String fileSys, String jobTracker,
			JobConf conf, String input, int numMaps, int numReduces)
			throws IOException {
		...
		{
			Path[] parents = FileUtil.stat2Paths(fs.listStatus(outDir
					.getParent()));
	...
	static String launchExternal(String fileSys, String jobTracker,
			JobConf conf, String input, int numMaps, int numReduces)
			throws IOException {
