...
public class TestJobSysDirWithDFS extends TestCase {
	private static final Log LOG = LogFactory.getLog(TestJobSysDirWithDFS.class
			.getName());
	...
	public static TestResult launchWordCount(JobConf conf, Path inDir,
		...
		assertFalse(FileSystem.get(conf).exists(
				new Path(conf.get("mapred.system.dir"))));
	...
	static void runWordCount(MiniMRCluster mr, JobConf jobConf)
			throws IOException {
