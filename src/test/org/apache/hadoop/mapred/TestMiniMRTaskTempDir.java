...
public class TestMiniMRTaskTempDir extends TestCase {
	private static final Log LOG = LogFactory
			.getLog(TestMiniMRTaskTempDir.class.getName());
	...
	public static class MapClass extends MapReduceBase implements
		...
		public void map(LongWritable key, Text value,
			...
			assertEquals(tmp, new Path(tmpFile.getParent()).makeQualified(
					localFs).toString());
		}
	 ...
	 * @throws IOException
	 */
	public void launchTest(JobConf conf, Path inDir, Path outDir, String input)
			throws IOException {
