...
public class TestFileInputFormat extends TestCase {
	...
	public void testLocality() throws Exception {
		...
		try {
			...
			DataOutputStream out = fs.create(path, true, 4096, (short) 2, 512,
					null);
			...
			for (int i = 0; i < splits.length; ++i) {
				...
				assertTrue((blockLocs[0].equals(splitLocs[0]) && blockLocs[1]
						.equals(splitLocs[1]))
						|| (blockLocs[1].equals(splitLocs[0]) && blockLocs[0]
								.equals(splitLocs[1])));
			}
		} finally {
			if (dfs != null) {
