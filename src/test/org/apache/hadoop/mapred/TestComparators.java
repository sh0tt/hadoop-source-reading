...
public class TestComparators extends TestCase {
	...
	static class RandomGenMapper implements
		...
		public void map(IntWritable key, Writable value,
			...
			for (int i = 0; i < num_values; ++i) {
				...
				out
						.collect(new IntWritable(compositeKey),
								new IntWritable(val));
			}
		}
	 ...
	 */
	static class IdentityMapper implements
	 ...
	 */
	static class AscendingKeysReducer implements
			Reducer<IntWritable, Writable, IntWritable, Text> {
	 ...
	 * Checks whether keys are in ascending order.
	 */
	static class DescendingKeysReducer implements
			Reducer<IntWritable, Writable, IntWritable, Text> {
		public void configure(JobConf job) {
		}
	 ...
	 */
	static class AscendingGroupReducer implements
	 ...
	 */
	static class DescendingGroupReducer implements
			Reducer<IntWritable, IntWritable, IntWritable, Text> {
	...
	public void configure() throws Exception {
		...
		SequenceFile.Writer writer = SequenceFile.createWriter(fs, conf,
				inFile, IntWritable.class, IntWritable.class);
		...
		writer = SequenceFile.createWriter(fs, conf, inFile, IntWritable.class,
				IntWritable.class);
