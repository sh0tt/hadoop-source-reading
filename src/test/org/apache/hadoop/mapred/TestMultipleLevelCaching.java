...
public class TestMultipleLevelCaching extends TestCase {
	...
	private void testCachingAtLevel(int level) throws IOException {
		...
		try {
			...
			mr = new MiniMRCluster(taskTrackers, namenode, 1,
					new String[] { rack2 }, new String[] { "host2.com" }, jc);
			 ...
			 * locality.
			 */
			TestRackAwareTaskPlacement.launchJobAndTestCounters(testName, mr,
					fileSys, inDir, outputPath, 1, 1, 0, 0);
			mr.shutdown();
		} finally {
