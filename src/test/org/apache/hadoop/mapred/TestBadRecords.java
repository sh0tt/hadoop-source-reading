...
public class TestBadRecords extends ClusterMapReduceTestCase {
	...
	private void runMapReduce(JobConf conf, List<String> mapperBadRecords,
		...
		conf.setMaxMapAttempts(SkipBadRecords.getAttemptsToStartSkipping(conf)
				+ 1 + mapperBadRecords.size());
		conf.setMaxReduceAttempts(SkipBadRecords
