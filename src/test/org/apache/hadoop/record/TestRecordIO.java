...
public class TestRecordIO extends TestCase {
	...
	public void testBinary() {
		...
		try {
			...
			istream.close();
			tmpfile.delete();
			assertTrue("Serialized and deserialized records do not match.", r1
					.equals(r2));
	...
	public void testCloneable() {
		...
		try {
			...
			assertTrue(
					"Cloneable semantics violated. r1.getClass() != r2.getClass()",
					r1.getClass() == r2.getClass());
			assertTrue("Cloneable semantics violated. !r2.equals(r1)", r2
					.equals(r1));
