...
public class TestTFileLzoCodecsByteArrays extends TestTFileByteArrays {
	/**
	 * Test LZO compression codec, using the same test cases as in the
	 * ByteArrays.
	 */
	@Override
	public void setUp() throws IOException {
		...
		// TODO: sample the generated key/value records, and put the numbers
		// below
		init(Compression.Algorithm.LZO.getName(), "memcmp",
				"TFileTestCodecsLzo", 2605, 2558);
		if (!skip)
			super.setUp();
	}
}
