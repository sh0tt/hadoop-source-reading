...
public class TestMapFile extends TestCase {
	...
	public void testGetClosest() throws Exception {
		...
		MapFile.Writer writer = new MapFile.Writer(conf, fs, qualifiedDirName
				.toString(), Text.class, Text.class);
		...
		MapFile.Reader reader = new MapFile.Reader(fs, qualifiedDirName
				.toString(), conf);
