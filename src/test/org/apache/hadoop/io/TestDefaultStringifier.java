...
public class TestDefaultStringifier extends TestCase {
	...
	private static final Log LOG = LogFactory
			.getLog(TestDefaultStringifier.class);
	...
	public void testWithWritable() throws Exception {
		...
		for (int i = 0; i < 10; i++) {
			...
			DefaultStringifier<Text> stringifier = new DefaultStringifier<Text>(
					conf, Text.class);
	...
	public void testWithJavaSerialization() throws Exception {
		...
		DefaultStringifier<Integer> stringifier = new DefaultStringifier<Integer>(
				conf, Integer.class);
	...
	public void testStoreLoadArray() throws IOException {
		...
		Integer[] claimedArray = DefaultStringifier.<Integer> loadArray(conf,
				keyName, Integer.class);
