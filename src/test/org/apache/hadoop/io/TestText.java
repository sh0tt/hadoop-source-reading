...
public class TestText extends TestCase {
	...
	public void testCoding() throws Exception {
		...
		for (int i = 0; i < NUM_ITERATIONS; i++) {
			...
			assertEquals(0, WritableComparator.compareBytes(utf8Text, 0, bb
	...
	public void testIO() throws Exception {
		...
		for (int i = 0; i < NUM_ITERATIONS; i++) {
			...
			String after2 = new String(out.getData(), strLenSize, out
					.getLength()
					- strLenSize, "UTF-8");
	...
	public void testCompare() throws Exception {
		...
		for (int i = 0; i < NUM_ITERATIONS; i++) {
			...
			assertEquals(comparator.compare(out1.getData(), 0,
					out3.getLength(), out3.getData(), 0, out3.getLength()), 0);
		}
	}
