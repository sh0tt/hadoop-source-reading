...
class InMemoryNativeFileSystemStore implements NativeFileSystemStore {
	...
	public void storeEmptyFile(String key) throws IOException {
		metadataMap.put(key, new FileMetadata(key, 0, System
				.currentTimeMillis()));
	...
	public void storeFile(String key, File file, byte[] md5Hash)
		...
		metadataMap.put(key, new FileMetadata(key, file.length(), System
				.currentTimeMillis()));
	...
	public InputStream retrieve(String key, long byteRangeStart)
		...
		try {
			...
			out.write(data, (int) byteRangeStart, data.length
					- (int) byteRangeStart);
		} finally {
			if (out != null) {
				out.close();
	...
	public void purge(String prefix) throws IOException {
		Iterator<Entry<String, FileMetadata>> i = metadataMap.entrySet()
				.iterator();
		while (i.hasNext()) {
