 ...
 * 
 */
public abstract class IOMapperBase extends Configured implements
		Mapper<UTF8, LongWritable, UTF8, UTF8> {
	 ...
	 * @throws IOException
	 */
	abstract Object doIO(Reporter reporter, String name, long value)
			throws IOException;
	 ...
	 * @throws IOException
	 */
	abstract void collectStats(OutputCollector<UTF8, UTF8> output, String name,
			long execTime, Object doIOReturnValue) throws IOException;
