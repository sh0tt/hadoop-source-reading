...
public class TestGlobExpander extends TestCase {
	...
	public void testExpansion() throws IOException {
		...
		checkExpansion("{a,b}/{b,{c/d,e/f}}", "{a,b}/b", "{a,b}/c/d",
				"{a,b}/e/f");
	...
	private void checkExpansion(String filePattern,
			String... expectedExpansions) throws IOException {
		List<String> actualExpansions = GlobExpander.expand(filePattern);
		assertEquals("Different number of expansions",
				expectedExpansions.length, actualExpansions.size());
