...
public class PiEstimator extends Configured implements Tool {
	...
	static private final Path TMP_DIR = new Path(PiEstimator.class
			.getSimpleName()
			+ "_TMP_3_141592654");
	...
	public static BigDecimal estimate(int numMaps, long numPoints,
		...
		try {
			...
			return BigDecimal.valueOf(4).setScale(20).multiply(
					BigDecimal.valueOf(numInside.get())).divide(
					BigDecimal.valueOf(numMaps)).divide(
