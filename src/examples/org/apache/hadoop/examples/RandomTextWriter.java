...
public class RandomTextWriter extends Configured implements Tool {
	...
	static class Map extends MapReduceBase implements
		...
		public void configure(JobConf job) {
			...
			wordsInKeyRange = (job.getInt("test.randomtextwrite.max_words_key",
					10) - minWordsInKey);
			minWordsInValue = job.getInt(
					"test.randomtextwrite.min_words_value", 10);
			wordsInValueRange = (job.getInt(
		...
		public void map(Text key, Text value,
			...
			while (numBytesToWrite > 0) {
				...
				reporter.incrCounter(Counters.BYTES_WRITTEN, (keyWords
