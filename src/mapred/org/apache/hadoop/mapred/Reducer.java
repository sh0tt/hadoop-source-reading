...
public interface Reducer<K2, V2, K3, V3> extends JobConfigurable, Closeable {
   ...
   * <a href="{@docRoot} provided to report progress or
	 ...
	 * href="{@docRoot} provided to report progress or
	 * just indicate that they are alive. In scenarios where the application
	 * takes an insignificant amount of time to process individual key/value
	 * pairs, this is crucial since the framework might assume that the task has
	 * timed-out and kill that task. The other way of avoiding this is to set <a
	 * href="{@docRoot} provided to report progress or just indicate that they
	 * are alive. In scenarios where the application takes an insignificant
	 * amount of time to process individual key/value pairs, this is crucial
	 * since the framework might assume that the task has timed-out and kill
	 * that task. The other way of avoiding this is to set <a href="{@docRoot}
	 * /../mapred-default.html#mapred.task.timeout"> mapred.task.timeout</a> to
	 * a high-enough value (or even zero for no time-outs).
	 * </p>
	 * 
	 * @param key
	 *            the key.
