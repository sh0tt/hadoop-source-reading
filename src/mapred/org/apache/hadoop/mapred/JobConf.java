...
public class JobConf extends Configuration {
	...
	public InputFormat getInputFormat() {
		return ReflectionUtils.newInstance(getClass(
	...
	public OutputCommitter getOutputCommitter() {
		return (OutputCommitter) ReflectionUtils.newInstance(getClass(
   ...
   * <a href="{@docRoot} multiplied by (&lt;<i>no. of nodes</i>&gt; * <a
	 * href="{@docRoot} multiplied by (&lt;<i>no. of nodes</i>&gt; * <a href="{@docRoot}
	 * multiplied by (&lt;<i>no. of nodes</i>&gt; * <a href="{@docRoot}
	...
	public void setProfileTaskRange(boolean isMap, String newValue) {
		...
		set(
				(isMap ? "mapred.task.profile.maps"
						: "mapred.task.profile.reduces"), newValue);
	}
   ...
   * ${mapred.local.dir}/taskTracker/jobcache/$jobid/work/ </code>
	 ...
	 * <code>job.local.dir </code>. So, the tasks can use this space as scratch
	 * space and share files among them.
	 * </p>
	...
	public long getMaxVirtualMemoryForTask() {
		LOG
				.warn("getMaxVirtualMemoryForTask() is deprecated. "
	...
	public void setMaxVirtualMemoryForTask(long vmem) {
		LOG
				.warn("setMaxVirtualMemoryForTask() is deprecated."
	...
	public void setMaxPhysicalMemoryForTask(long mem) {
		LOG
				.warn("The API setMaxPhysicalMemoryForTask() is deprecated."
