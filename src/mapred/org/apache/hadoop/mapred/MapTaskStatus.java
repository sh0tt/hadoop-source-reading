...
class MapTaskStatus extends TaskStatus {
	...
	public MapTaskStatus(TaskAttemptID taskid, float progress, State runState,
	...
	public long getSortFinishTime() {
		throw new UnsupportedOperationException(
				"getSortFinishTime() not supported for MapTask");
	}

	@Override
	void setSortFinishTime(long sortFinishTime) {
		throw new UnsupportedOperationException(
				"setSortFinishTime() not supported for MapTask");
	}
}
