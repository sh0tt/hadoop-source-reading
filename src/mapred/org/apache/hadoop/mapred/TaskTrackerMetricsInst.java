...
class TaskTrackerMetricsInst extends TaskTrackerInstrumentation implements
		Updater {
	...
	public void doUpdates(MetricsContext unused) {
		synchronized (this) {
			...
			metricsRecord.setMetric("mapTaskSlots", (short) tt
					.getMaxCurrentMapTasks());
			metricsRecord.setMetric("reduceTaskSlots", (short) tt
					.getMaxCurrentReduceTasks());
