...
public class TaskAttemptID extends org.apache.hadoop.mapreduce.TaskAttemptID {
	 ...
	 */
	public static TaskAttemptID downgrade(
			org.apache.hadoop.mapreduce.TaskAttemptID old) {
		if (old instanceof TaskAttemptID) {
			return (TaskAttemptID) old;
		} else {
			return new TaskAttemptID(TaskID.downgrade(old.getTaskID()), old
					.getId());
		}
	}
	...
	public static TaskAttemptID forName(String str)
			throws IllegalArgumentException {
		return (TaskAttemptID) org.apache.hadoop.mapreduce.TaskAttemptID
				.forName(str);
	}
	...
	static StringBuilder getTaskAttemptIDsPatternWOPrefix(String jtIdentifier,
		...
		builder.append(
				TaskID.getTaskIDsPatternWOPrefix(jtIdentifier, jobId, isMap,
						taskId)).append(SEPARATOR).append(
				attemptId != null ? attemptId : "[0-9]*");
		return builder;
	}
}
