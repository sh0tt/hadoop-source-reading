 ...
 * 
 */
public class FieldSelectionMapReduce<K, V> implements Mapper<K, V, Text, Text>,
	...
	private String specToString() {
		...
		sb.append("mapOutputKeyValueSpec: ").append(mapOutputKeyValueSpec)
				.append("\n");
		sb.append("reduceOutputKeyValueSpec: ")
				.append(reduceOutputKeyValueSpec).append("\n");

		sb.append("allMapValueFieldsFrom: ").append(allMapValueFieldsFrom)
				.append("\n");

		sb.append("allReduceValueFieldsFrom: ")
				.append(allReduceValueFieldsFrom).append("\n");
	 ...
	 * output.
	 */
	public void map(K key, V val, OutputCollector<Text, Text> output,
	...
	public void configure(JobConf job) {
		...
		this.mapOutputKeyValueSpec = job.get(
				"map.output.key.value.fields.spec", "0-:");
