...
class MRSortResultIterator implements RawKeyValueIterator {
	...
	public MRSortResultIterator(OutputBuffer keyValBuffer, int[] pointers,
			int[] startOffsets, int[] keyLengths, int[] valLengths) {
	...
	public ValueBytes getValue() throws IOException {
		...
		value.reset(keyValBuffer, startOffsets[currStartOffsetIndex]
				+ keyLengths[currStartOffsetIndex],
