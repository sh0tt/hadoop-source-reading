...
public class RecInt extends org.apache.hadoop.record.Record {
	...
	static {
		_rio_recTypeInfo = new org.apache.hadoop.record.meta.RecordTypeInfo(
				"RecInt");
		_rio_recTypeInfo.addField("data",
	...
	public int compareTo(final Object _rio_peer_) throws ClassCastException {
		...
		int _rio_ret = 0;
		_rio_ret = (data == _rio_peer.data) ? 0 : ((data < _rio_peer.data) ? -1
				: 1);
		if (_rio_ret != 0)
			return _rio_ret;
		return _rio_ret;
	...
	static {
		org.apache.hadoop.record.RecordComparator.define(RecInt.class,
				new Comparator());
	}
}
