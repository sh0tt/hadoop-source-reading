...
public class RecRecordNew extends org.apache.hadoop.record.Record {
	...
	static {
		_rio_recTypeInfo = new org.apache.hadoop.record.meta.RecordTypeInfo(
				"RecRecordNew");
		_rio_recTypeInfo.addField("name2",
	...
	public RecRecordNew(
			...
			final int i1, final java.util.TreeMap<Long, String> map1,
	...
	public void serialize(final org.apache.hadoop.record.RecordOutput _rio_a,
		...
		_rio_a.writeInt(i1, "i1");
		{
			...
			java.util.Set<java.util.Map.Entry<Long, String>> _rio_es1 = map1
					.entrySet();
			for (java.util.Iterator<java.util.Map.Entry<Long, String>> _rio_midx1 = _rio_es1
	...
	public int compareTo(final Object _rio_peer_) throws ClassCastException {
			...
			return _rio_ret;
		{
			...
			for (int _rio_vidx1 = 0; _rio_vidx1 < _rio_len11
				...
				java.util.ArrayList<Integer> _rio_e21 = _rio_peer.svec
						.get(_rio_vidx1);
				{
					...
					for (int _rio_vidx2 = 0; _rio_vidx2 < _rio_len12
						...
						_rio_ret = (_rio_e12 == _rio_e22) ? 0
								: ((_rio_e12 < _rio_e22) ? -1 : 1);
						if (_rio_ret != 0) {
							return _rio_ret;
						}
					}
	...
	public Object clone() throws CloneNotSupportedException {
		...
		_rio_other.svec = (java.util.ArrayList<java.util.ArrayList<Integer>>) this.svec
				.clone();
			...
			try {
				...
				}
				{
					...
					for (int midx1 = 0; midx1 < mi1; midx1++) {
						{
							long i = org.apache.hadoop.record.Utils.readVLong(
									b, s);
							int z = org.apache.hadoop.record.Utils
									.getVIntSize(i);
							s += z;
			...
			try {
				...
				}
				{
					...
					for (int midx1 = 0; midx1 < mi11 && midx1 < mi21; midx1++) {
						{
							long i1 = org.apache.hadoop.record.Utils.readVLong(
									b1, s1);
							long i2 = org.apache.hadoop.record.Utils.readVLong(
									b2, s2);
							if (i1 != i2) {
								return ((i1 - i2) < 0) ? -1 : 0;
							}
	...
	static {
		org.apache.hadoop.record.RecordComparator.define(RecRecordNew.class,
				new Comparator());
	}
}
