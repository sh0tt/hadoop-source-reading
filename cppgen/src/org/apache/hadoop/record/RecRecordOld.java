...
public class RecRecordOld extends org.apache.hadoop.record.Record {
	...
	static {
		_rio_recTypeInfo = new org.apache.hadoop.record.meta.RecordTypeInfo(
				"RecRecordOld");
		_rio_recTypeInfo.addField("name",
				org.apache.hadoop.record.meta.TypeID.StringTypeID);
		_rio_recTypeInfo.addField("ivec",
				new org.apache.hadoop.record.meta.VectorTypeID(
						org.apache.hadoop.record.meta.TypeID.LongTypeID));
		_rio_recTypeInfo.addField("svec",
				new org.apache.hadoop.record.meta.VectorTypeID(
						new org.apache.hadoop.record.meta.VectorTypeID(
								new org.apache.hadoop.record.meta.StructTypeID(
										org.apache.hadoop.record.RecRecord0
												.getTypeInfo()))));
		_rio_recTypeInfo.addField("inner",
				new org.apache.hadoop.record.meta.StructTypeID(
						org.apache.hadoop.record.RecRecord0.getTypeInfo()));
		_rio_recTypeInfo
				.addField(
						"strvec",
						new org.apache.hadoop.record.meta.VectorTypeID(
								new org.apache.hadoop.record.meta.VectorTypeID(
										new org.apache.hadoop.record.meta.VectorTypeID(
												org.apache.hadoop.record.meta.TypeID.StringTypeID))));
		_rio_recTypeInfo.addField("i1",
				org.apache.hadoop.record.meta.TypeID.FloatTypeID);
		_rio_recTypeInfo.addField("map1",
				new org.apache.hadoop.record.meta.MapTypeID(
						org.apache.hadoop.record.meta.TypeID.ByteTypeID,
						org.apache.hadoop.record.meta.TypeID.StringTypeID));
		_rio_recTypeInfo
				.addField(
						"mvec1",
						new org.apache.hadoop.record.meta.VectorTypeID(
								new org.apache.hadoop.record.meta.MapTypeID(
										org.apache.hadoop.record.meta.TypeID.IntTypeID,
										org.apache.hadoop.record.meta.TypeID.LongTypeID)));
		_rio_recTypeInfo
				.addField(
						"mvec2",
	...
	public RecRecordOld(
			...
			final float i1, final java.util.TreeMap<Byte, String> map1,
	...
	public static void setTypeFilter(
		...
		org.apache.hadoop.record.RecRecord0.setTypeFilter(rti
				.getNestedStructTypeInfo("RecRecord0"));
	}
	...
	public void serialize(final org.apache.hadoop.record.RecordOutput _rio_a,
		...
		}
		{
			...
			for (int _rio_vidx1 = 0; _rio_vidx1 < _rio_len1; _rio_vidx1++) {
				java.util.ArrayList<org.apache.hadoop.record.RecRecord0> _rio_e1 = svec
						.get(_rio_vidx1);
				{
					_rio_a.startVector(_rio_e1, "_rio_e1");
					int _rio_len2 = _rio_e1.size();
					for (int _rio_vidx2 = 0; _rio_vidx2 < _rio_len2; _rio_vidx2++) {
						org.apache.hadoop.record.RecRecord0 _rio_e2 = _rio_e1
								.get(_rio_vidx2);
		...
		inner.serialize(_rio_a, "inner");
		{
			...
			for (int _rio_vidx1 = 0; _rio_vidx1 < _rio_len1; _rio_vidx1++) {
				java.util.ArrayList<java.util.ArrayList<String>> _rio_e1 = strvec
						.get(_rio_vidx1);
				{
					_rio_a.startVector(_rio_e1, "_rio_e1");
					int _rio_len2 = _rio_e1.size();
					for (int _rio_vidx2 = 0; _rio_vidx2 < _rio_len2; _rio_vidx2++) {
						java.util.ArrayList<String> _rio_e2 = _rio_e1
								.get(_rio_vidx2);
						{
		...
		_rio_a.writeFloat(i1, "i1");
		{
			...
			java.util.Set<java.util.Map.Entry<Byte, String>> _rio_es1 = map1
					.entrySet();
			for (java.util.Iterator<java.util.Map.Entry<Byte, String>> _rio_midx1 = _rio_es1
		...
		}
		{
			...
			for (int _rio_vidx1 = 0; _rio_vidx1 < _rio_len1; _rio_vidx1++) {
				java.util.TreeMap<Integer, Long> _rio_e1 = mvec1
						.get(_rio_vidx1);
				{
					_rio_a.startMap(_rio_e1, "_rio_e1");
					java.util.Set<java.util.Map.Entry<Integer, Long>> _rio_es1 = _rio_e1
							.entrySet();
					for (java.util.Iterator<java.util.Map.Entry<Integer, Long>> _rio_midx1 = _rio_es1
							.iterator(); _rio_midx1.hasNext();) {
						java.util.Map.Entry<Integer, Long> _rio_me1 = _rio_midx1
								.next();
		...
		}
		{
			...
			for (int _rio_vidx1 = 0; _rio_vidx1 < _rio_len1; _rio_vidx1++) {
				java.util.TreeMap<Integer, Long> _rio_e1 = mvec2
						.get(_rio_vidx1);
				{
					_rio_a.startMap(_rio_e1, "_rio_e1");
					java.util.Set<java.util.Map.Entry<Integer, Long>> _rio_es1 = _rio_e1
	...
	private void deserializeWithoutFilter(
		...
		{
			org.apache.hadoop.record.Index _rio_vidx1 = _rio_a
					.startVector("ivec");
		...
		}
		{
			...
			for (; !_rio_vidx1.done(); _rio_vidx1.incr()) {
				...
				{
					org.apache.hadoop.record.Index _rio_vidx2 = _rio_a
							.startVector("_rio_e1");
			...
			for (; !_rio_vidx1.done(); _rio_vidx1.incr()) {
				java.util.ArrayList<java.util.ArrayList<String>> _rio_e1;
				{
					...
					for (; !_rio_vidx2.done(); _rio_vidx2.incr()) {
						...
						{
							org.apache.hadoop.record.Index _rio_vidx3 = _rio_a
									.startVector("_rio_e2");
							...
							for (; !_rio_vidx2.done(); _rio_vidx2.incr()) {
								java.util.ArrayList<String> _rio_e2;
								{
									org.apache.hadoop.record.Index _rio_vidx3 = _rio_a
											.startVector("_rio_e2");
									_rio_e2 = new java.util.ArrayList<String>();
									for (; !_rio_vidx3.done(); _rio_vidx3
											.incr()) {
										String _rio_e3;
										_rio_e3 = _rio_a.readString("_rio_e3");
										_rio_e2.add(_rio_e3);
	...
	public int compareTo(final Object _rio_peer_) throws ClassCastException {
			...
			return _rio_ret;
		{
			...
			for (int _rio_vidx1 = 0; _rio_vidx1 < _rio_len11
					&& _rio_vidx1 < _rio_len21; _rio_vidx1++) {
				long _rio_e11 = ivec.get(_rio_vidx1);
				long _rio_e21 = _rio_peer.ivec.get(_rio_vidx1);
				_rio_ret = (_rio_e11 == _rio_e21) ? 0
						: ((_rio_e11 < _rio_e21) ? -1 : 1);
				if (_rio_ret != 0) {
					return _rio_ret;
				}
			}
			...
			return _rio_ret;
		{
			...
			for (int _rio_vidx1 = 0; _rio_vidx1 < _rio_len11
					&& _rio_vidx1 < _rio_len21; _rio_vidx1++) {
				java.util.ArrayList<org.apache.hadoop.record.RecRecord0> _rio_e11 = svec
						.get(_rio_vidx1);
				java.util.ArrayList<org.apache.hadoop.record.RecRecord0> _rio_e21 = _rio_peer.svec
						.get(_rio_vidx1);
				{
					int _rio_len12 = _rio_e11.size();
					int _rio_len22 = _rio_e21.size();
					for (int _rio_vidx2 = 0; _rio_vidx2 < _rio_len12
							&& _rio_vidx2 < _rio_len22; _rio_vidx2++) {
						org.apache.hadoop.record.RecRecord0 _rio_e12 = _rio_e11
								.get(_rio_vidx2);
						org.apache.hadoop.record.RecRecord0 _rio_e22 = _rio_e21
								.get(_rio_vidx2);
			...
			return _rio_ret;
		{
			...
			for (int _rio_vidx1 = 0; _rio_vidx1 < _rio_len11
					&& _rio_vidx1 < _rio_len21; _rio_vidx1++) {
				java.util.ArrayList<java.util.ArrayList<String>> _rio_e11 = strvec
						.get(_rio_vidx1);
				java.util.ArrayList<java.util.ArrayList<String>> _rio_e21 = _rio_peer.strvec
						.get(_rio_vidx1);
				{
					int _rio_len12 = _rio_e11.size();
					int _rio_len22 = _rio_e21.size();
					for (int _rio_vidx2 = 0; _rio_vidx2 < _rio_len12
							&& _rio_vidx2 < _rio_len22; _rio_vidx2++) {
						java.util.ArrayList<String> _rio_e12 = _rio_e11
								.get(_rio_vidx2);
						java.util.ArrayList<String> _rio_e22 = _rio_e21
								.get(_rio_vidx2);
						{
							int _rio_len13 = _rio_e12.size();
							int _rio_len23 = _rio_e22.size();
							for (int _rio_vidx3 = 0; _rio_vidx3 < _rio_len13
									&& _rio_vidx3 < _rio_len23; _rio_vidx3++) {
			...
			return _rio_ret;
		{
			...
			for (; _rio_miter10.hasNext() && _rio_miter20.hasNext();) {
				...
				_rio_ret = (_rio_k10 == _rio_k20) ? 0
						: ((_rio_k10 < _rio_k20) ? -1 : 1);
				if (_rio_ret != 0) {
					return _rio_ret;
				}
			}
			...
			return _rio_ret;
		{
			...
			for (int _rio_vidx1 = 0; _rio_vidx1 < _rio_len11
					&& _rio_vidx1 < _rio_len21; _rio_vidx1++) {
				java.util.TreeMap<Integer, Long> _rio_e11 = mvec1
						.get(_rio_vidx1);
				java.util.TreeMap<Integer, Long> _rio_e21 = _rio_peer.mvec1
						.get(_rio_vidx1);
				{
					java.util.Set<Integer> _rio_set10 = _rio_e11.keySet();
					java.util.Set<Integer> _rio_set20 = _rio_e21.keySet();
					java.util.Iterator<Integer> _rio_miter10 = _rio_set10
							.iterator();
					java.util.Iterator<Integer> _rio_miter20 = _rio_set20
							.iterator();
					for (; _rio_miter10.hasNext() && _rio_miter20.hasNext();) {
			...
			return _rio_ret;
		{
			...
			for (int _rio_vidx1 = 0; _rio_vidx1 < _rio_len11
					&& _rio_vidx1 < _rio_len21; _rio_vidx1++) {
				java.util.TreeMap<Integer, Long> _rio_e11 = mvec2
						.get(_rio_vidx1);
				java.util.TreeMap<Integer, Long> _rio_e21 = _rio_peer.mvec2
						.get(_rio_vidx1);
				{
					java.util.Set<Integer> _rio_set10 = _rio_e11.keySet();
					java.util.Set<Integer> _rio_set20 = _rio_e21.keySet();
	...
	public Object clone() throws CloneNotSupportedException {
		...
		_rio_other.svec = (java.util.ArrayList<java.util.ArrayList<org.apache.hadoop.record.RecRecord0>>) this.svec
				.clone();
		_rio_other.inner = (org.apache.hadoop.record.RecRecord0) this.inner
				.clone();
		_rio_other.strvec = (java.util.ArrayList<java.util.ArrayList<java.util.ArrayList<String>>>) this.strvec
				.clone();
		_rio_other.i1 = this.i1;
		_rio_other.map1 = (java.util.TreeMap<Byte, String>) this.map1.clone();
		_rio_other.mvec1 = (java.util.ArrayList<java.util.TreeMap<Integer, Long>>) this.mvec1
				.clone();
		_rio_other.mvec2 = (java.util.ArrayList<java.util.TreeMap<Integer, Long>>) this.mvec2
				.clone();
		return _rio_other;
	}
			...
			try {
				...
				}
				{
					...
					for (int vidx1 = 0; vidx1 < vi1; vidx1++) {
						...
						int vz2 = org.apache.hadoop.record.Utils
								.getVIntSize(vi2);
						s += vz2;
						l -= vz2;
						for (int vidx2 = 0; vidx2 < vi2; vidx2++) {
							int r = org.apache.hadoop.record.RecRecord0.Comparator
									.slurpRaw(b, s, l);
							s += r;
							l -= r;
						}
				...
				}
				{
					...
					for (int vidx1 = 0; vidx1 < vi1; vidx1++) {
						...
						l -= vz2;
						for (int vidx2 = 0; vidx2 < vi2; vidx2++) {
							int vi3 = org.apache.hadoop.record.Utils.readVInt(
									b, s);
							int vz3 = org.apache.hadoop.record.Utils
									.getVIntSize(vi3);
							s += vz3;
							l -= vz3;
							for (int vidx3 = 0; vidx3 < vi3; vidx3++) {
								int i = org.apache.hadoop.record.Utils
										.readVInt(b, s);
				...
				}
				{
					if (l < 4) {
						throw new java.io.IOException(
								"Float is exactly 4 bytes. Provided buffer is smaller.");
					}
					s += 4;
					l -= 4;
				}
					...
					for (int midx1 = 0; midx1 < mi1; midx1++) {
						{
							if (l < 1) {
								throw new java.io.IOException(
										"Byte is exactly 1 byte. Provided buffer is smaller.");
							}
							s++;
							l--;
						}
				...
				}
				{
					...
					for (int vidx1 = 0; vidx1 < vi1; vidx1++) {
						int mi1 = org.apache.hadoop.record.Utils.readVInt(b, s);
						int mz1 = org.apache.hadoop.record.Utils
								.getVIntSize(mi1);
						s += mz1;
						l -= mz1;
						for (int midx1 = 0; midx1 < mi1; midx1++) {
							...
							{
								long i = org.apache.hadoop.record.Utils
										.readVLong(b, s);
								int z = org.apache.hadoop.record.Utils
										.getVIntSize(i);
								s += z;
			...
			try {
				...
				}
				{
					...
					for (int vidx1 = 0; vidx1 < vi11 && vidx1 < vi21; vidx1++) {
						long i1 = org.apache.hadoop.record.Utils.readVLong(b1,
								s1);
						long i2 = org.apache.hadoop.record.Utils.readVLong(b2,
								s2);
						if (i1 != i2) {
							return ((i1 - i2) < 0) ? -1 : 0;
						}
				...
				}
				{
					...
					l2 -= vz21;
					for (int vidx1 = 0; vidx1 < vi11 && vidx1 < vi21; vidx1++) {
						int vi12 = org.apache.hadoop.record.Utils.readVInt(b1,
								s1);
						int vi22 = org.apache.hadoop.record.Utils.readVInt(b2,
								s2);
						int vz12 = org.apache.hadoop.record.Utils
								.getVIntSize(vi12);
						int vz22 = org.apache.hadoop.record.Utils
								.getVIntSize(vi22);
						s1 += vz12;
						s2 += vz22;
						l1 -= vz12;
						...
						for (int vidx2 = 0; vidx2 < vi12 && vidx2 < vi22; vidx2++) {
							int r1 = org.apache.hadoop.record.RecRecord0.Comparator
									.compareRaw(b1, s1, l1, b2, s2, l2);
							if (r1 <= 0) {
								return r1;
							}
							s1 += r1;
				...
				}
				{
					...
					for (int vidx1 = 0; vidx1 < vi11 && vidx1 < vi21; vidx1++) {
						...
						l2 -= vz22;
						for (int vidx2 = 0; vidx2 < vi12 && vidx2 < vi22; vidx2++) {
							int vi13 = org.apache.hadoop.record.Utils.readVInt(
									b1, s1);
							int vi23 = org.apache.hadoop.record.Utils.readVInt(
									b2, s2);
							int vz13 = org.apache.hadoop.record.Utils
									.getVIntSize(vi13);
							int vz23 = org.apache.hadoop.record.Utils
									.getVIntSize(vi23);
							s1 += vz13;
							s2 += vz23;
							l1 -= vz13;
							...
							for (int vidx3 = 0; vidx3 < vi13 && vidx3 < vi23; vidx3++) {
								int i1 = org.apache.hadoop.record.Utils
										.readVInt(b1, s1);
								int i2 = org.apache.hadoop.record.Utils
										.readVInt(b2, s2);
				...
				}
				{
					...
					l2 -= vz21;
					for (int vidx1 = 0; vidx1 < vi11 && vidx1 < vi21; vidx1++) {
						int mi11 = org.apache.hadoop.record.Utils.readVInt(b1,
								s1);
						int mi21 = org.apache.hadoop.record.Utils.readVInt(b2,
								s2);
						int mz11 = org.apache.hadoop.record.Utils
								.getVIntSize(mi11);
						int mz21 = org.apache.hadoop.record.Utils
								.getVIntSize(mi21);
						s1 += mz11;
						s2 += mz21;
						l1 -= mz11;
	...
	static {
		org.apache.hadoop.record.RecordComparator.define(RecRecordOld.class,
				new Comparator());
	}
}
